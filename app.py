...
MODEL_FILES = ["best_model_compatible.pkl", "best_model (2).pk1", "best_model.pk1"]
model = None
...
if model is None:
    st.error("⚠️ No trained model found in the folder. Please place a model file like 'best_model_compatible.pkl'.")
    st.stop()
...
if uploaded_file is not None:
    try:
        ...
        for col in FULL_OCCUPATION_COLS:import streamlit as st
import pandas as pd
import joblib
import numpy as np
import os
